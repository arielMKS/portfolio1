// https://codepen.io/DevWL/pen/ZWewPO
...
//  === ARIEL: MODIFY APPENDCHILD SO THE BUTTON SHOWS UP INSIDE "OUTERWRAPPER" INSTEAD OF THE BODY
//  === OTHERWISE, IF OUTERWRAPPER === BODY SIZE, THEN BUTTON WOULD NOT BE VISIBLE
//  === NICE FIX, PROUD OF IT!!
// document.getElementById('outerWrapperId').appendChild(this.button);
}
...
// *Set options
var options = {
'showButtonAfter': 500, // show button after scroling down this amount of px
